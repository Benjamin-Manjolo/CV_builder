...
export const templates: CVTemplate[] = [
  ...
  // New templates
  {
    id: "tech-sidebar",
    name: "Tech Sidebar",
    description: "A sidebar layout that highlights technical skills front and center — ideal for developers.",
    category: "Professional",
    isPremium: false,
    thumbnailColor: "hsl(180, 40%, 25%)",
    sections: ["header", "summary", "experience", "education", "skills"],
    defaultContent: { ...defaultContent },
    theme: {
      primaryColor: "#0e7490",
  ...
  },
  {
    id: "split-modern",
    name: "Split Modern",
    description: "A balanced two-column design that maximizes space for both experience and skills.",
    category: "Minimalist",
    isPremium: false,
  ...
  },
  {
    id: "compact-pro",
    name: "Compact Pro",
    description: "Fits more content on one page with tight, professional spacing. Great for experienced candidates.",
    category: "Professional",
    isPremium: true,
    price: 4.99,
