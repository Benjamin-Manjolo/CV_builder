...
const features = [
  {
    ...
    description: "Professionally designed CV templates for every industry and career stage.",
  },
  {
    icon: FileText,
    title: "In-Browser Editor",
    description: "Edit your CV with our intuitive WYSIWYG editor — no software downloads needed.",
  },
  {
    icon: Download,
    title: "Instant PDF Download",
    description: "Export your finished CV as a pixel-perfect PDF with a single click.",
  },
  {
    icon: Wifi,
    title: "Works Offline",
    description: "Once loaded, edit and download your CV even without an internet connection.",
  },
];
    ...
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-background rounded-lg p-8 shadow-elevated border-2 border-primary relative">
          ...
          <Button variant="hero" className="w-full">Start Pro</Button>
        </div>
        {/* Pro Yearly */}
        <div className="bg-background rounded-lg p-8 shadow-soft border">
          ...
          <Button variant="hero-outline" className="w-full">Start Pro Yearly</Button>
        </div>
      </div>
    </div>
  </section>
...
export { Navbar, HeroSection, FeaturesSection, PricingSection, Footer };
